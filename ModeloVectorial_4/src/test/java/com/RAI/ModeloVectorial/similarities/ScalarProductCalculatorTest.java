...
public class ScalarProductCalculatorTest {
    ...
    public void testCalculate() {
        ...
        Indexer.indizar(documentsToAdd, dicc, false);
        ...
        DocVector docVector1 = vectorizer.toVector(doc1, dicc, calculatorTFIDF);
        DocVector docVector2 = vectorizer.toVector(doc2, dicc, calculatorTFIDF);
        DocVector queryVector = vectorizer.toVector(query, dicc, calculatorTFIDF);
